...
import ComponenteCampo from './componentes/ComponenteCampo/index'
...
class Pagina extends Component {
    ...
    cambiaModal = (_evento, method = "POST", newState = {}) => {
        let _newState = { ...newState, mostrarModal: !this.state.mostrarModal, method, };
        if (method === "POST") {
    ...
    editarEntidad = async (_evento, index) => {
        ...
        this.cambiaModal(null, "PUT", newState);
    };
